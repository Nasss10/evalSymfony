...
class LieuRepository extends ServiceEntityRepository
{
    ...
    public function findAllUniqueVilles(): array
    {
    ...
    public function findAppartementsByVille(?string $ville): array
    {
        $queryBuilder = $this->createQueryBuilder('l')
            ->innerJoin('l.appart_id', 'a')
            ->addSelect('a')
            ->orderBy('a.Titre', 'ASC');

        if ($ville) {
            $queryBuilder->where('l.ville = :ville')
